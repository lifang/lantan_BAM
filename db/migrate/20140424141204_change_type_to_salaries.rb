class ChangeTypeToSalaries < ActiveRecord::Migration
  ...
  change_column :salaries, :total, :decimal,{:precision=>"21,1",:default=>0}
  ...
  change_column :salaries, :fact_fee, :decimal,{:precision=>"21,1",:default=>0}
  ...
  change_column :salaries, :base_salary, :decimal,{:precision=>"21,1",:default=>0}
  change_column :staffs, :secure_fee, :decimal,{:precision=>"21,1",:default=>0}
  change_column :staffs, :reward_fee, :decimal,{:precision=>"21,1",:default=>0}
end
