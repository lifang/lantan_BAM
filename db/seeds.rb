...
#系统管理员功能权限
RoleModelRelation.create(:role_id => num+1, :model_name => 'customers', :num => 511)
RoleModelRelation.create(:role_id => num+1, :model_name => 'materials', :num => 8191)
RoleModelRelation.create(:role_id => num+1, :model_name => 'staffs', :num => 16383)
RoleModelRelation.create(:role_id => num+1, :model_name => 'datas', :num => 31)
RoleModelRelation.create(:role_id => num+1, :model_name => 'stations', :num => 3)
RoleModelRelation.create(:role_id => num+1, :model_name => 'sales', :num => 4095)
