...
//   alert($(obj).is(":checked"));
    if($(obj).is(":checked")){
        ...
        li += code + "</td><td>" + name + "</td><td>" + type + "</td><td>" + price +
            "</td><td><input type='text' id='out_num_"+$(obj).attr("id")+"' value='1' onkeyup=\"set_order_num(this,'"+$(obj).val()+"','"+id+"','"+price+"','"+obj.code+"')\" style='width:50px;'/></td><td>" +
        ...
        select_str += id + "_1_"+ price + "_"+ code +",";
...
function set_order_num(obj,storage,m_id,m_price,m_code){
    ...
    if($("#from").val()==0 && parseInt($(obj).val())>parseInt(storage)){
        ...
        for(var i=0;i<select_itemts.length;i++){
            if(select_itemts[i].split("_")[0]==$(obj).parent().parent().attr("id").split("_")[2]){
                select_itemts[i] = select_itemts[i].split("_")[0] + "_" + $(obj).val() + "_" + select_itemts[i].split("_")[2] + "_" + m_code;
            }
        }
...
function add_material_to_selected(obj,order_count){
    ...
    li += obj.code + "</td><td>" + obj.name + "</td><td>" + type_name(obj.types) + "</td><td>" + parseFloat(obj.price) + "</td>"
        + "<td><input type='text' id='out_num_mat_"+id+"' value='"+order_count+"' onkeyup=\"set_order_num(this,'"+obj.storage+"','"+id+"','"+obj.price+"','"+obj.code+"')\" style='width:50px;'/></td><td>" +
