...
//   alert($(obj).is(":checked"));
    if($(obj).is(":checked")){
        ...
        li += m.name + "</td><td>" + type + "</td><td>" + m.price +
            "</td><td>" + (typeof(m.sale_price)=="undefined" ? "无" : m.sale_price) +"</td><td><input type='text' id='out_num_"+$(obj).attr("id")+"' value='1' onkeyup=\"set_order_num(this,'"+$(obj).val()+"','"+id+"','"+m.price+"','"+m.code+"','"+type+"')\" style='width:50px;'/></td><td>" +
