...
module UserRoleHelper
  ...
  def cookie_role(user_id)
    ...
    for role in roles
      ...
      if model_role["lantan".to_sym]
        model_role["lantan".to_sym] = model_role["lantan".to_sym].to_i|gankao_model_role.right_sum.to_i
      else
        model_role["lantan".to_sym] = gankao_model_role.right_sum.to_i
    ...
    if cookies[:user_id]
      ...
      if cookies[:model_role]
        ...
        for j in (0..model_roles.length)
          if model_roles[j].to_s == "lantan".to_s
