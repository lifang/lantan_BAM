...
module Constant
  ...
  ROLES = {
    ...
    :materials => {
      ...
      :receive => ["确认已收货",8388608],
      :mat_edit => ["编辑", 16777216],
      :delete => ["删除", 33554432],
      :return => ["退货", 67108864],
      :add_supplier => ["添加供应商",134217728],
      :supplier => ["查看供应商",268435456],
      :edit_supplier => ["编辑供应商",536870912],
      :delete_supplier => ["删除供应商",1073741824]
    },
    :staffs => {
      :name => "员工",
      :add_staff => ["新建员工",1],
